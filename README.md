...
The Configuration Frames are used to create configuration dialogs, according to the following structure:
...
It is assumed that we work with an XML file, where the work variables are saved.
